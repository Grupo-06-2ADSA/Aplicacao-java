...
public class ComputadorDAO {
    public static void cadastrarComputador(Computador computador) {
        String sql = "INSERT INTO Maquina (hostname, ip, fkSala, fkEmpresa) VALUES (?, ?, ?, ?)";
        ...
        try {
            ...
            ps2.setInt(3, computador.getFkSala());
            ps2.setString(4, computador.getFkEmpresa());
            ps2.execute();
            ...
            psSql.setInt(3, computador.getFkSala());
            psSql.setString(4, computador.getFkEmpresa());
            psSql.execute();
